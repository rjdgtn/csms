...
constexpr unsigned char Crc8Table_0x31[256] = {
...
constexpr unsigned char Crc8Table_0x9B[256] = {
...
inline unsigned char Crc8(unsigned char *pcBlock, unsigned char len, const unsigned char Crc8Table[256])
{
